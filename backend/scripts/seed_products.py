...
DEFAULT_SOURCE = os.path.join(
    os.path.dirname(__file__), "..", "public", "mock", "catalogue.json"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Path to product json (frontend mock) or a list of product entries",
    )
